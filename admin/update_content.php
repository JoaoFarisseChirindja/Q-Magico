...
<h1 class="heading">atualizar conteúdo</h1>
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <p>atualizar título <span>*</span></p>
   <input type="text" name="title" maxlength="100" required placeholder="digite o título do vídeo" class="box" value="<?= $fecth_videos['title']; ?>">
   <p>atualizar descrição <span>*</span></p>
   ...
   <select name="playlist" class="box">
      <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--selecione a playlist</option>
      <?php
      ...
      <?php
         ...
         echo '<option value="" disabled>nenhuma playlist criada ainda!</option>';
      }
      ?>
   </select>
   ...
   <input type="submit" value="atualizar conteúdo" name="update" class="btn">
   <div class="flex-btn">
      <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">ver conteúdo</a>
      <input type="submit" value="deletar conteúdo" name="delete_video" class="delete-btn">
   </div>
</form>
<?php
      }
   }else{
      echo '<p class="empty">vídeo não encontrado! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">adicionar vídeos</a></p>';
   }
?>
