...
<div class="box-container">
   ...
   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">Criar Novo Conteúdo</h3>
      <a href="add_content.php" class="btn">Adicionar Conteúdo</a>
   </div>
   ...
   ?>
      <div class="box">
         <div class="flex">
            <div>
               ...
               <span style="<?php if($fecth_videos['status'] == 'active'){echo 'color:limegreen'; }else{echo 'color:red';} ?>">
                  <?= $fecth_videos['status'] == 'active' ? 'Ativo' : 'Inativo'; ?>
               </span>
            </div>
            <div>
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Excluir" class="delete-btn" onclick="return confirm('Deseja excluir este vídeo?');" name="delete_video">
         </form>
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Visualizar Conteúdo</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">Nenhum conteúdo adicionado ainda!</p>';
      }
   ?>
